...
enum MessagePool {
    static let gratitude: [String] = [
        ...
        "Notice something that is working well today.",
        "What made you smile recently?",
        "Find something you usually take for granted.",
        "Name a kindness someone showed you lately.",
        "What strength do you appreciate in yourself?",
        "What are you glad exists in the world?",
        "Name one small pleasure you enjoyed today.",
    ...
    static let bodyAwareness: [String] = [
        ...
        "Take one slow, deliberate breath right now.",
